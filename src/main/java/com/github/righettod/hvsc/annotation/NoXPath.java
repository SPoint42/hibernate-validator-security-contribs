 ...
 * check that the string do not contains any character that can be interpreted in a XPATH filter expression.
 * 
...
@Retention(RUNTIME)
@Constraint(validatedBy = NoXPathValidator.class)
@Documented
public @interface NoXPath {
	...
	String message() default "{com.github.righettod.hvsc.annotation.noxpath}";
